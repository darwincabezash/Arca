...
function tableUtil(){
    ...
    $('.dt-add').each(function () {
      $(this).on('click', function(evt){
        ...
        rowData.push('<button type="button" class="btn btn-primary btn-xs dt-edit" style="margin-right:16px;"> <i class="fas fa-user-edit fa-2x"></i></button><button type="button" class="btn btn-danger btn-xs dt-delete"><i class="fas fa-trash fa-2x ml-1 mr-1"></i></button>');
